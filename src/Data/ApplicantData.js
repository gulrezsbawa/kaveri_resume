const KaveriData = {
  applicantName: "Kaveri",
  designation: "Senior Business Associate",
  briefSummary:
  ...
  professionServices: {
    ...
    list: [
      ...
      {
        name: "Edifecs Technologies Private Limited",
        year: "2016 - 2018",
        subTitle: "Associate Product Support Specialist",
        details: [
...
export const applicantData = KaveriData;
